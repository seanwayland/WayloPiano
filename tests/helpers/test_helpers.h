 ...
 *
  runWithinPluginEditor ([&] (WayloPianoAudioProcessor& plugin) {
 ...
 */
[[maybe_unused]] static void runWithinPluginEditor (const std::function<void (WayloPianoAudioProcessor& plugin)>& testCode)
{
